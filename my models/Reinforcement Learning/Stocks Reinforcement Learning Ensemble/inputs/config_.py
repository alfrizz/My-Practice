...
train_init_quarters = 24
valid_quarters = 4
trade_quarters = 1
max_rebalances_input= 1
rebalance_quarters= 1
...
TECHNICAL_INDICATORS_LIST = ["MACD","RSI21","CCI21","ATR21", "ADX21"]
...
# timesteps: how long the model will train (balance underfit/overfit)
# ent_coeff: balance exploration and exploitation

A2C_PARAMS = {"n_steps": 5,
              "ent_coef": 0.01, # entropy coefficient facilitates exploration
              "learning_rate": 0.0001, 
              "verbose": 0}
A2C_TS = 55000

# A2C_HYPAR = {'buffer_size': trial.suggest_categorical("buffer_size", [int(1e4), int(1e5), int(1e6)]),
...
DDPG_PARAMS = {"learning_rate": 0.001, 
               "batch_size": 128, 
               "buffer_size": 1000, 
               "verbose": 0}
DDPG_TS = 2000
...
# Dow 30 constituents at 2024/01
