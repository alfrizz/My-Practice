...
#######################################################################################################################################################   
    ...
    def step(self, actions):
        ...
        if self.terminal: # If the trading period is over:
            ...
            print('\nVALID initial asset', self.asset_memory[0])
            print('VALID end_total_asset', self.end_total_asset)
            print('VALID total_reward', self.end_total_asset - self.asset_memory[0], '==', np.sum(self.rewards_memory))
            print("VALID total_cost: ", self.cost)
            print("VALID total trades: ", self.trades)
            print("VALID Sharpe Ratio: ",self.sharpe, ',\n')            
